...
write.xlsx(table1, file = xlsx, sheetName = 'Table 1')
addPicture('consort.png', sheet = "Consort")
write.xlsx(bf.visit.five, file = xlsx, sheetName = 'Bonferroni Significant')

insertPlot(wb, 1, width = 5, height = 3.5, fileType = "png", units = "in")
bf.visit.five %>% write.csv()
fifth.lasso
